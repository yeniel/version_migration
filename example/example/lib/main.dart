...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    VersionMigration.migrateToVersion("1.0.1", () {
      ...
      SharedPreferences.getInstance().then((sharedPreferences) {
        ...
        sharedPreferences.setInt(newLastSavedCounterKey, counter);
      });
    });
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  // Version 1.0.0
  String lastSavedCounterKey = "oldLastSavedCounterKey";

  // Version 1.0.1
//  String lastSavedCounterKey = "newLastSavedCounterKey";
